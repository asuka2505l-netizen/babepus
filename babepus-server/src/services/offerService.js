...
const createOffer = async (buyerId, payload) => {
  // Atomic check and create offer to prevent race conditions
  const connection = await pool.getConnection();
  try {
    await connection.beginTransaction();

    // Check product availability within transaction
    ...
    // Check for existing pending offers within transaction
